# 🚀 fileShare.app v1.0.0 - Universal Linux Distribution
...
| `fileshare_1.0.0.deb` | ~25KB | Debian/Ubuntu package |
| `fileshare-1.0.0-1.noarch.rpm` | ~30KB | Red Hat/Fedora package |
